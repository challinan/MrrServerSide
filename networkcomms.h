...
public slots:
    void NewConnection();
    void connected();       // Generated by QAbstractSocket, emitted after connectToHost() has been called
    ...
    void errorOccurred(QAbstractSocket::SocketError socketError);   // Any error from the socket (generated by QAbstractSocket)
